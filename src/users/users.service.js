...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (user) {
            return this.usersRepository.save(user);
        };
        UsersService_1.prototype.update = function (userId, userInformation) {
            return this.usersRepository.update(userId, userInformation);
        };
        UsersService_1.prototype.getCertifiedImages = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.imageRepository.find({ where: { userId: userId, isCertified: true } })];
                });
            });
        };
