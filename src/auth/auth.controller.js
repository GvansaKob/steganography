...
var AuthController = function () {
    var _classDecorators = [(0, public_decorator_1.Public)(), (0, common_1.Controller)('auth')];
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.register = function (registerBody) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.register(registerBody)];
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('local')), (0, common_1.Post)('login')];
