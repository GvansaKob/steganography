...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!isMatch) {
                                throw new common_1.BadRequestException('Le mot de passe ne fonctionne pas.');
                            }
        ...
        AuthService_1.prototype.register = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, hashedPassword, newUser;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.findOneByEmail(user.email)];
                        case 1:
                            existingUser = _a.sent();
                            if (existingUser) {
                                throw new common_1.BadRequestException('Cet email existe déjà.');
                            }
                            return [4 /*yield*/, bcrypt.hash(user.password, 10)];
                        case 2:
                            hashedPassword = _a.sent();
                            newUser = __assign(__assign({}, user), { password: hashedPassword });
                            return [4 /*yield*/, this.usersService.create(newUser)];
                        case 3:
                            _a.sent();
                            return [2 /*return*/, this.login(newUser)];
                    }
                });
            });
        };
