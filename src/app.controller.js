...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.getHello = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.appService.getHello(user.id)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        AppController_1.prototype.getTestMe = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, 'Hello from a public route!'];
                });
            });
        };
    ...
    (function () {
        ...
        _getTestMe_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)('test-me')];
        ...
        __esDecorate(_classThis, null, _getTestMe_decorators, { kind: "method", name: "getTestMe", static: false, private: false, access: { has: function (obj) { return "getTestMe" in obj; }, get: function (obj) { return obj.getTestMe; } }, metadata: _metadata }, null, _instanceExtraInitializers);
